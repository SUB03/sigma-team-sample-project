...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-purchase-service-key-change-in-production')
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "purchase.authentication.MicroserviceJWTAuthentication",
    ],
}
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get('DB_NAME', 'purchase_db'),
